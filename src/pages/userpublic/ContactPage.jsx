          ...
          <div className="bg-white rounded-xl shadow p-6 md:p-8">
            ...
            <div className="space-y-3 text-gray-700 text-sm">
              <div>
                ...
                <p>Use the 'Report Profile' button on the artisan's profile page.</p>
              </div>
              <div>
                <strong>How long does verification take?</strong>
                <p>Typically 1-2 business days after submitting required documents.</p>
              </div>
              <div>
                <strong>Is there a fee for using CraftConnect?</strong>
                <p>
                  No, it's free for homeowners to find artisans. Artisans pay a small commission
                  on completed jobs.
                </p>
              </div>
            </div>
