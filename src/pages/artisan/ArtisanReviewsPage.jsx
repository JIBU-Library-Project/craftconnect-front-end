  ...
  const reviews = [
    {
      ...
      userName: "Babs Morla",
      userProfilePic: "/profiles/user4.jpg",
    },
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center">
            <div className="relative mr-4">
              ...
              />
              <div
                className={`absolute -bottom-1 -right-1 rounded-full px-2 py-1 text-xs font-medium ${getRatingColor(
                  review.rating
                )}`}
              >
                {review.rating}.0
...
const EmptyState = () => (
  <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-12 text-center">
    ...
    <p className="text-gray-500 mb-6 max-w-md mx-auto">
      Your reviews will appear here once customers rate your services. Complete
      jobs to get feedback.
    </p>
